...
const rootRoute = loggedInUser() ? 'me/report-data/report-filter' : 'auth/login';
...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'me', loadChildren: () => import('./me-database/me-database.module').then(m => m.MeDatabaseModule) },
    ]
  },
